            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="px-6 py-2 rounded-md bg-[#0ff]/20 border-none text-[#0ff] border border-[#0ff] hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0ff]/60 flex items-center gap-3"
                >
